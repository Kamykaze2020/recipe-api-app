...
class RecipeSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        ingredients = validated_data.pop('ingredients', []) # create ingredients feature
        recipe = Recipe.objects.create(**validated_data)
        self._get_or_create_tags(tags, recipe)
        self._get_or_create_ingredients(ingredients, recipe) # create ingredients feature
        # auth_user = self.context['request'].user
        # for tag in tags:
        #     tag_obj, created = Tag.objects.get_or_create(
        #         user=auth_user,
    ...
    def update(self, instance, validated_data):
        ...
        ingredients = validated_data.pop('ingredients', None) # for update recipe
        if tags is not None:
            instance.tags.clear()
